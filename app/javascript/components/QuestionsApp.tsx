...
const QuestionsApp: React.FunctionComponent<IQuestionsAppProps> = ({ user_id, is_student, lecture_id, course_id, interactions_enabled, questions_list }) => {
    ...
    rootStore.questionsList.setQuestionsList(questions_list);
